...
const aptitudeQuestionsPath = path.join(__dirname, 'data', 'aptitude_questions.json');
const gratitudeQuestions = JSON.parse(fs.readFileSync(aptitudeQuestionsPath, 'utf8'));
